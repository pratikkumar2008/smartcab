...
class LearningAgent(Agent):
    ...
    def get_maxQ(self, state):
        ...
        #maxAction = max(qstate, key=qstate.get)
    ...
    def choose_action(self, state):
        ...
        if self.learning and random.random()>self.epsilon:
            ...
            posActions = []
            pos_actions = [act for act, value in self.Q[state].iteritems() if value == maxVal]
            #qstate = self.Q[state]
            #for act,value in qstate.iteritems():
            #    if value == maxVal:
...
def run():
    ...
    agent = env.create_agent(LearningAgent, learning=True,epsilon=0.999)
